...
| Name | Description |
|------|-------------|
| <a name="output_cloudfront_domain_name"></a> [cloudfront\_domain\_name](#output\_cloudfront\_domain\_name) | to get the Cloud front URL if doamin/alias is not configured |  
<!-- END_TF_DOCS -->