...
Creates a Lambda that gets integrated with an API gateway
...
| <a name="output_path_prefix"></a> [path\_prefix](#output\_path\_prefix) | Path prefix for the Lambda function |
| <a name="output_routes"></a> [routes](#output\_routes) | Route endpoints the lambda supports |
| <a name="output_stage_name"></a> [stage\_name](#output\_stage\_name) | Stage name for the API gateway |  
<!-- END_TF_DOCS -->